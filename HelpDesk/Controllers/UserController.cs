...
{
    [Authorize(Roles = "Администратор, Модератор, Исполнитель")] // Устанавливаем разные доступы по пролям
    public class UserController : Controller
    {
        ...
        {
            var users = db.Users.Include(u => u.Department).Include(u => u.Role).ToList(); //Добавляем пользователя и информацию о связанных с ними отделах
        ...
        [HttpGet]
        [Authorize(Roles = "Администратор")]
        public ActionResult Edit(int id) //редактирование
        {
        ...
        [Authorize(Roles = "Администратор")]
        public ActionResult Delete(int id) //удаление
        {
            User user = db.Users.Find(id);
